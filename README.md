...
- **시크릿**: `DATABASE_URL`(Managed Postgres 연결), `JWT_SECRET`은 Fly에 설정되어 있습니다. Google·Gemini·CORS는 필요 시 예시처럼 추가합니다.
  - `fly secrets set GOOGLE_CLIENT_ID="..." GEMINI_API_KEY="..." CORS_ORIGIN="https://your-frontend.example" -a tmap-web-be`
